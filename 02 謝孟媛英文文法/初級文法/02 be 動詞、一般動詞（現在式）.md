...
> [!WARNING]
> **練習卷錯題回填（2026-07-17，[[初級02 be 動詞、一般動詞（現在式）練習卷]]）　💬 AI 補充**
> - ❌ trys ✅ **tries**——子音＋y → 去 y＋ies，該套沒套。與 [[01 名詞、冠詞]] 練習的 heries（誤套）合看，同一條規則兩頭都倒過，已升級收進 [[易錯點總表]]。
> - ❌ does not watch**e** ✅ does not **watch**——回原形要把 **+es 整組拔掉**，不是只拔 -s（watches→watch、goes→go、washes→wash）；+es 的 e 是變化時附加的零件，不屬於原形。
