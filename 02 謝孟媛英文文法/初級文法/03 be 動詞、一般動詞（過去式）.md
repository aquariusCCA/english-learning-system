...
> [!WARNING]
> **練習卷錯題回填　💬 AI 補充**（非來源內容，取自 [[初級03 be 動詞、一般動詞（過去式）練習卷]]）
> - **規則動詞「重複字尾」漏掉**：❌ droped → ✅ **dropped**——「子音＋短母音＋子音」（drop、clap、stop…）要**重複字尾再加 ed**。
> - **-ed 發音把 /ɪd/ 誤判成 /t/**：hate → hated 應唸 ❌ /t/ → ✅ **/ɪd/**——**字尾原本發 /t/ 或 /d/ 就多一個音節**（和 wanted、needed 同組）；/t/ 那組是 walk、like、wash 這種「無聲、但非 /t/ /d/」結尾。
