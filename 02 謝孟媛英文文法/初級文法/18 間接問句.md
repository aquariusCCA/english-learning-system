...
## 🧭 直接問句 vs 間接問句
- **直接問句**（＝ WH 問句）：疑問詞 + be／助動詞 + 主詞（+ 原形動詞）?　（Who **is** that tall girl?（那高個子的女孩是誰？））
- **間接問句**：主要子句 + **疑問詞 + 主詞 + 動詞**　（I have no idea **who that tall girl is**.（我不知道那高個子的女孩是誰。））
...
> [!NOTE]
> **wh- to V 的簡化條件　💬 AI 補充**
> 改寫自外部文章 [happyfish〈wh- to V〉](https://happyfish.blog/pattern-what-to-v/)（第三方文章）：疑問詞名詞子句可簡化成「wh- + to V」，條件是 **①名詞子句與主要子句主詞（或受詞）相同、②子句含 should／can**。例：knew what he could do → knew **what to do**；knew where they should go → knew **where to go**；wonders when he can pop the question → wonders **when to pop the question**（何時求婚）。
