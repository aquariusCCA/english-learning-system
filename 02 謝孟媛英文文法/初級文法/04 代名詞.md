...
- **強調用法**（放主詞後）：He **himself** can do it.／I saw the singer **himself**.（我看見那位歌手本人。）不可寫 Himself can do it.，反身不可當主詞。
...
- A: Will it be fine tomorrow?（明天天氣好嗎？）B: I hope **so**.（我希望如此。so = that it will be fine tomorrow）
- Do you still feel sick? If **so**, you must see the doctor.（你還覺得不舒服嗎？如果是這樣，你一定要去看醫生。so 指前面的狀況 you still feel sick）
- Nancy can play the violin, and **so can I**.（Nancy 會拉小提琴，而我也會。so + 助動詞/be + 主詞 = 「也…」；so can I = I can, too）
- 比較：She is smart. **So she is.**（她很聰明，她的確如此。so + 主詞 + be／助動詞 ＝ 強調「的確如此」，主詞同前）／She is smart. **So is he.**（她很聰明，他也是。）
...
- **副詞用法「也／也不」**：肯定句用 too（句尾）／so + 倒裝；否定句用 either（句尾）／neither + 倒裝。
  ...
  - either 解釋成「也不」時，前面一定會看到否定的 not。
