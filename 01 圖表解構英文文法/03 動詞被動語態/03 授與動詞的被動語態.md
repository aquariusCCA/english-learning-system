...
>
> **⚠️ 8/6 讀後回想實測到的三個落點**（十一題，授與動詞這一片本身穩、倒的都是別的零件）
> - ❌ The old temple was **showed** to the tourists.　✅ was **shown**（show–showed–**shown**）。同批的 sent／made／lent／given／baked 五個 p.p. 全對——**它們都是第二欄第三欄同形**；兩欄不同形的字，第三欄會被第二欄頂掉。被動句是唯一會強迫你單獨叫出第三欄的位置。
> - ❌ The library has lent Kevin three new books. → Kevin **is** lent…／Three new books **is** lent…　✅ Kevin **has been** lent…／Three new books **have been** lent…（**原句的時式要一起帶過去**，完成式留 been、進行式留 being；換時式的完整做法見 [[01 各種時式的被動語態]]）
> - ❌ Three new books **is** lent　✅ **have been** lent（be／助動詞跟**新主詞**的數走——這句要同時處理「數」和「完成式」，一擠就掉數這一格）
>
