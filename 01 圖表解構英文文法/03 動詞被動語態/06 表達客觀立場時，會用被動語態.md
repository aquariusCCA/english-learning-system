...
- [ ] Q1：把 `It is believed that the castle is haunted.` 改寫成「S. ＋ be ＋ p.p. ＋ to V.」的寫法。
- [ ] Q2：把 `Many people think that she is the best candidate.` 改成 It 開頭的客觀說法。
- [ ] Q3：下面這句錯在哪？`The suspect is reported that he left the country.`
- [ ] Q4：`It is said that he lost all his money.` 改成人當主詞要怎麼寫？

<details>
<summary>✅ 解答</summary>

A1：**The castle is believed to be haunted.**（子句主詞 the castle 上來當主詞，is → to be）
A2：**It is thought that she is the best candidate.**（不點名是誰想的，用虛主詞 It ＋ be ＋ p.p. ＋ that 子句；也可寫成 She is thought to be the best candidate.）
A3：兩種寫法混用了——人當主詞就不能再接 that 子句 → **It is reported that the suspect left the country.** 或 **The suspect is reported to have left the country.**
A4：**He is said to have lost all his money.**（「賠光錢」發生在「據說」之前，是更早的事，不定詞用完成式 to have ＋ p.p.）
