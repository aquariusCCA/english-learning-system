...
- ⟨2026-07-31 檢核二 6⟩ **首次在產出端自己寫出完整的違規句**（前幾次都只是改錯端沒挖到）
  - 題目：**昨晚**我在雨中等我姊姊等了半小時。
  - ❌ `I **had waited** my sister for thirty minutes in the rain **last night**.`
  - ✅ `**Last night** I **waited for** my sister in the rain for half an hour.`
  - `had` ＋ `last night` 是本條原樣重演。過去完成式的存在意義是**在兩個過去動作之間標出誰更早**（7-1）——這句只有 last night 一個時間點，沒有第二個動作可以比，had 就沒有工作可做。
  - 要讓 had waited 成立，得補上參考點：`I **had waited** for half an hour **before she finally showed up**.`
  - ⚠️ 同句另倒在 `waited my sister` → `waited **for** my sister`（等待對象要接 for，第三次）。兩個 for 各司其職：`waited ⌈for my sister⌋ … ⌈for half an hour⌋`，前面標對象、後面標期間。
- 一句話記：**看到 yesterday／last Friday／ago，完成式不論 have 或 had 一律出局**——要用 had，先問「另一個更晚的過去動作在哪」。
