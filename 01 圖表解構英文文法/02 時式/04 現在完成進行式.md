...
>
> ![時間軸示意：時態只承諾從起點到「現在」一直開著，現在之後在鏡頭外；之後兩種收尾都合法——還在下（期間詞＋沒停跡象的默認讀法），或剛停、痕跡還新鮮（Have you been crying? 眼睛紅）](images/時間軸-現在完成進行式-承諾範圍.svg)
>
...
>
> 「誤解模型」的對照圖與完整推演（waiting 句、鏡頭差）在 [[08 過去完成進行式]] 8-1 的 💬 補充，此處不重複。
