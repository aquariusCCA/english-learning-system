...
> [!TIP]
> **💬 AI 補充｜這個時態保證到哪裡——只保證「到現在為止，動作一直在進行」**
> 上表的「還在下／還繼續住」很容易讀成「以後也一定會繼續」。其實現在完成進行式只管到「現在」為止：
>
...
> - **所以上表的「還在下／還繼續住」是情境上的默認讀法，不是這個時態的意思**——配著期間詞（for three days）、又沒有停止跡象時，自然讀成還在進行。但 Your eyes are red. **Have you been crying?**（哭已經停了、痕跡還新鮮）證明「剛停」也是合法讀法。
