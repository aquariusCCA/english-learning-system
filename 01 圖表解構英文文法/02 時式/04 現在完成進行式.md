...
- ⚠️ **同一份驗收裡要填完成進行式的空格共四格，四格全倒**：現在（本題）、過去（I-6 had been watching、I-10 had been burning）、未來（II-6 will have been playing）。但同一份卷子（一）單一選擇題裡的五題完成進行式**全部答對**——其中第 20 題的答案就是 had been watching，跟 I-6 該填的字**一模一樣**。選項擺在眼前挑得出來、要自己寫就寫不出來，缺的是**產出**，不是規則。
