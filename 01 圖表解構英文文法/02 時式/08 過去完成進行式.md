...
> 8-1 三個例句中，Jim 和媽媽那兩句「之後還會繼續做」，waiting 句她一出現等待就結束——看似矛盾，其實是把**情境推論**誤讀成**時態承諾**。
>
> **① 時態只承諾「到參考點為止一直開著」；參考點之後，鏡頭沒拍。**
>
> ![時間軸示意：誤解模型以為參考點之後必須繼續做（❌）；實際上時態只承諾到參考點為止一直開著，參考點之後在鏡頭外、繼不繼續由情境決定（✅）](images/時間軸-過去完成進行式-承諾範圍.svg)
>
> | 例句 | 到那一刻一直在做？ | 之後呢？ | 誰決定的 |
> | --- | --- | --- | --- |
> | Jim **had been working** for two hours（我到辦公室時） | ✅ | 大概繼續 | 情境：我到了，不會讓他停工 |
> | mom **had been preparing** dinner（我到家前） | ✅ | 繼續 | 情境：飯還沒好——書上括號「（而且還繼續在忙）」是**情境註記，不是定義** |
...
> `We had waited for over an hour` 也完全合法、意思幾乎一樣。wait／work／live 這類動詞上，兩種寫法差的只是**鏡頭**：had waited ＝ 事後結算（總共等了一個多小時）；had been waiting ＝ 拉回現場（她現身那一秒我們還站在那裡等），常帶不耐煩／累的情緒。要看到**事實差異**，得換有終點的動詞：
> - When she showed up, I **had read** her report. → **讀完了**（結果在手）
> - When she showed up, I **had been reading** her report. → **讀到一半**（被打斷）
>
> 檢查法一句話：**問「參考點那一刻，動作還在跑嗎？」還在跑 → had been V-ing；「之後還跑不跑」不歸時態管。**
