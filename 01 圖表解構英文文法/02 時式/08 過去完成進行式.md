...
> [!TIP]
> **💬 學習驗收對照補充**（章末學習驗收（四）10，2026-07-31——**這題不算錯**，記的是表達差距）

**③ 「一直都在當」：had been ＋ 名詞說得通，had been working as 才譯得出「一直」（驗收（四）10）**
- 題目：Jennifer 在拍攝第一部電影前，她**一直都在**當女服務生。
- △ Before she made her first movie, Jennifer **had been** a waitress.（文法完全正確，意思是「在那之前她曾是女服務生」）
- ✅ Before she made her first movie, Jennifer **had been working as** a waitress.
- 為什麼：兩句都合法，差別在**有沒有把「一直」譯出來**。`had been ＋ 名詞` 敘述的是那段期間的**身分**；中文的「一直都在當」帶的是**持續累積**的味道，那正是 had been V-ing 的地盤（8-1）。
- ⚠️ **本篇上方「常見錯誤」欄第三條就把這兩種寫法並列過**：❌ had been **being** a lifeguard ✅ had been **working as** a lifeguard／had been a lifeguard。那一條講的是「哪個不合法」，這一題講的是**兩個都合法時，題目要的是哪一個**。
- ⚠️ **這一格沒有進 [[易錯點總表]]**：在役表只收真正錯掉的東西（[[使用說明]] 4-2「在役表求精」）。文法沒違規，就留在這裡當對照。
- 一句話記：**中文寫「一直都在……」→ had been V-ing；只說「曾經是……」→ had been ＋ 名詞。**
